...
void fromTorqueToAngularVels(const float torques[4], float armLength, float kT, float kQ, float angularVels[4]) {
    float C[16];
    float U[16];
    float V[16];
...
/* End of code generation (fromTorqueToAngularVels.c) */
